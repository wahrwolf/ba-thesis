...
\newcommand{\trtype}{Bachelorthesis} %{Diplomarbeit} %{Dissertation}
...
\newcommand{\trcourseofstudies}{Informatik} %{Bioinformatik} %{Intelligent Adaptive Systems} 
\newcommand{\trauthordegree}{} %{\ B.Sc.}
\newcommand{\trgutachterA}{\href{mailto:wermter@informatik.uni-hamburg.de}{Prof. Dr. S. Wermter}}
\newcommand{\trgutachterB}{\href{mailto:tbd@informatik.uni-hamburg.de}{Dr. To Be Defined}}
