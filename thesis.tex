...
\newcommand{\trtype}{Bachelor Thesis} 				%{Expos\'{e}} %{Review}
...
\usepackage{hyperref}					% Pandoc needs it to generate clickable titles
\usepackage{apacite}					% Extended cite options/style
